...
public class Grades extends TableImpl<GradesRecord> {
    ...
    /**
     * The column <code>grades.username</code>.
     */
    public final TableField<GradesRecord, String> USERNAME = createField(DSL.name("username"), SQLDataType.CLOB.nullable(false), this, "");
